...
public readonly struct UtcTimeOfDay : IEquatable<UtcTimeOfDay>
{
    ...
    /// <summary>
    ///   Converts the value of the current <see cref="UtcTimeOfDay"/> instance to its equivalent short time string representation.
    /// </summary>
    ...
    /// <summary>
    ///   Converts the value of the current <see cref="UtcTimeOfDay"/> instance to its equivalent long time string representation.
    /// </summary>
    ...
    /// <summary>
    ///   Converts the value of the current <see cref="UtcTimeOfDay"/> instance to its equivalent
