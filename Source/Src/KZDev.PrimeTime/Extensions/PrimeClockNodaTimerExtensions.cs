...
//################################################################################
/// <summary>
///   Extension methods for <see cref="IPrimeClock"/> <see cref="Duration"/>-based interval timer registration.
/// </summary>
public static class PrimeClockNodaTimerExtensions
{
    #region IPrimeClock — Interval timers (Duration)

    private static readonly Duration NoRepeatDuration = Duration.FromTimeSpan(Timeout.InfiniteTimeSpan);
    ...
    #endregion IPrimeClock — Interval timers (Duration)

    #region IPrimeClock — Time-of-day timers (LocalTime)
