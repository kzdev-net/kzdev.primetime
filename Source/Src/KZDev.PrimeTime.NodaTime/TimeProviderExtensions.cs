...
// Phase 14: Extension methods to obtain a TimeProvider from a PrimeTime NodaTime clock.

namespace KZDev.PrimeTime;

/// <summary>
///   Extension methods for obtaining a <see cref="TimeProvider"/> from PrimeTime NodaTime clocks.
/// </summary>
public static class PrimeClockTimeProviderExtensions
{
    /// <summary>
    ///   Returns a <see cref="TimeProvider"/> that uses the given PrimeTime NodaTime clock
    ///   for <see cref="TimeProvider.GetUtcNow"/>, <see cref="TimeProvider.GetLocalNow"/>,
    ///   and <see cref="TimeProvider.CreateTimer"/>.
    /// </summary>
    /// <param name="clock">
    ///   The PrimeTime NodaTime clock (e.g. <see cref="PrimeClock"/> or
