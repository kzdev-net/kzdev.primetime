...
public static class PrimeTimeScheduleZoneExtensions
{
    ...
    extension(IPrimeTime time)
    {
        ...
        /// </exception>
        public DateTimeOffset ToScheduleDateTimeOffset (DateTimeOffset instant)
        {
            if (time is null)
        ...
        /// </exception>
        public DateTimeOffset ToScheduleDateTimeOffset (DateTime utcDateTime)
        {
        ...
        ///   <paramref name="time"/> is not an <see cref="IPrimeClock"/> and the schedule zone cannot be resolved.
        /// </exception>
        public DateTime ToScheduleLocalWallDateTime (DateTimeOffset instant)
        {
        ...
        ///   an <see cref="IPrimeClock"/>.
        /// </exception>
        public DateTime ToScheduleLocalWallDateTime (DateTime utcDateTime)
        {
        ...
        ///   </para>
        /// </remarks>
        public DateOnly ToScheduleDateOnly (DateTimeOffset instant)
        {
        ...
        ///   </para>
        /// </remarks>
        public DateOnly ToScheduleDateOnly (DateTime utcDateTime)
        {
        ...
        ///   </para>
        /// </remarks>
        public TimeOnly ToScheduleTimeOnly (DateTimeOffset instant)
        {
            DateTime wall = time.ToScheduleLocalWallDateTime(instant);
        ...
        ///   </para>
        /// </remarks>
        public TimeOnly ToScheduleTimeOnly (DateTime utcDateTime)
        {
            DateTime wall = time.ToScheduleLocalWallDateTime(utcDateTime);
            return TimeOnly.FromDateTime(wall);
        }
