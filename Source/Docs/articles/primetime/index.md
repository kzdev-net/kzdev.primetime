# PrimeTime (NodaTime) track

Use **KZDev.PrimeTime** when you want **`Instant`**, **`Duration`**, **`LocalTime`**, and related **NodaTime** timer overloads on **`IPrimeClock`**.

## In this track

- **[Usage guide](primetime-superset.md)** — NodaTime-first workflow and DI defaults.
- **[Examples](examples/index.md)** — runnable production and testing snippets pulled directly from the in-repo example projects.
- **[Testing packages guide](../testing-packages.md#primetime-stack)** — conceptual guide for paired testing packages (not a substitute for generated API pages below).
