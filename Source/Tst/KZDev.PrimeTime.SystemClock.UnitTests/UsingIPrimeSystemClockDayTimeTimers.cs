...
//
// Unit tests for IPrimeSystemClock RegisterTimeOfDay and RegisterAsyncTimeOfDay (Phase 10).
// Uses real time; full determinism comes with PrimeTestSystemClock (Phase 12).
